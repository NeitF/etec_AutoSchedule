    ...
    <div class="container fundoBranco">
        <div class="row">
            <div class="col-7 mt-5">
                <h2>Realizar cadastro de turmas</h2>
                <form method="post" action="processarTurma.php">
                    <label class="mt-4">Turma:</label>
                    <br>
                    <input name="turma" type="text" size="30">
                    <br><br>
                    <label>Código:</label>
                    <br>
                    <input name="codigo" type="text" size="30">                  
                    <br><br>
