...
$sql = "insert into tblMaterias (materiaID, materiaNome, materiaDescricao, materiaTecnica, materiaCor) values (NULL, '$nome', '$descricao', '$tecnico', '$cor')";
    ...
    <div class="container fundoBranco">
        <div class="row">
            <div class="col-7 mt-5">
                <h2>Matéria cadastrada com sucesso!</h2>             
                <br><br>
